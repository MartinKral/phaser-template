export class PreloaderBar {
    ...
    public constructor(btnGraphicsName: string, posY: number, scene: Phaser.Scene) {
        this.scene = scene;
    ...
    private fillPositions(posY: number): void {
        this.posX = this.scene.game.canvas.width / 2;
        this.posY = posY;
    }

    private addPreloaderImage(btnGraphicsName: string): void {
    ...
    private createPreloaderMask(): void {
